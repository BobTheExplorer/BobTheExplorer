<?php
	...
	$encryption_key		= 'dfrtyuuyhgrr';			// Unique 8 to 32 character encryption key
	$notification_email	= 'norway1786@protonmail.com';	// E-mail for notification of new comments
	$admin_nickname		= 'Watcher';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'kldflrltlylu';			// Password to gain admin rights
